...
export const APP_FEATURES = [
  {
    ...
    description: "Get interview questions based on your selected role and experience level.",
  },
  {
    id: "02",
    title: "Learn at Your Own Pace",
    description: "No pressure—access structured interview prep whenever it suits you.",
  },
  {
    id: "03",
    title: "Capture Your Insights",
    description: "Take notes or reflect on answers to track your thought process over time.",
  },
  {
    id: "04",
    title: "Understand the Why Behind Answers",
    description: "Learn not just the right answer, but the reasoning behind it.",
  },
  {
    id: "05",
    title: "Save, Organize, and Revisit",
    description: "Bookmark up to 5 key questions or sessions for quick revision later.",
  },
]
